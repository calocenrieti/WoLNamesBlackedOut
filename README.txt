...
既知の不具合
CUDAもしくはCPUで一度何か処理した後、他方に変更しても変更が反映されず、前回と同じデバイスでの処理になります。
CUDAスイッチ自体をなくしてもいいかなと思っています。

レディチェック時のパーティメンバー名が消しきれません。
レイズを受けた時の、レイズをしてくれたユーザ名が消えません。
チャット欄に流れるLSチャットのユーザ名が不得意です。FCチャットも同様かと思われます。
ターゲット、フォーカスターゲットにユーザをターゲットしている場合、消すの不得意です。
→どこかのタイミングでアノテーション作業をして追加学習させたいと思っています。
